...
class Review(TypedDict):
    ...
    summary:Annotated[str, 'A breif review of the purchased product']
    sentiment: Annotated[str, 'Return the sentiment of the review be it positive,negative or neutral']
